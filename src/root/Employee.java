...
public class Employee implements Comparable {
    ...
    public int compareTo(Object o) {
        if (getClass() != o.getClass()) {
            throw new IllegalArgumentException("That is not an Employee object");
        }
        Employee obj = (Employee) o;
        int objValue = Integer.valueOf(obj.ssn.substring(0, 1));
        int thisValue = Integer.valueOf(this.ssn.substring(0, 1));
        if(objValue > thisValue){
            return 1;
        }else if(objValue == thisValue){
            return 0;
        }else{
            return -1;
        }
